...
import { User, Mail, Lock, Eye, EyeOff, ArrowRight, BookOpen, AlertCircle } from 'lucide-react';
...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(authFailure(err.message || 'Signup failed. Please try again.'));
    }
  };
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-light-500">
            Start tracking your progress and unlocking interactive modules
          </p>
        </div>
              ...
              <div>
                ...
                <div className="relative rounded-xl border border-light-200 bg-light-50 border-glow-focus transition-all duration-200">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <User className="h-5 w-5 text-light-500" />
                  </div>
                  <input
                    type="text"
                    required
